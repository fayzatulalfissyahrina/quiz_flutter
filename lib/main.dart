...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void HitungLuasKubus(){
    double sisi = double.parse(panjangController.text);
  ...
  void HitungLuasTabung(){
    double jarijari = double.parse(panjangController.text);
    double tinggi = double.parse(tinggiController.text);

    double luastabung = 2 * 3.14 * jarijari * (jarijari + tinggi);
    setState(() {
      print(luastabung);
    });
  }
          ...
          children: <Widget>[
            ...
            TextFormField(
              ...
              decoration:const InputDecoration(
                ...
                labelText: 'input panjang balok / sisi kubus / jari-jari tabung',
              ),
            ...
            TextFormField(
              ...
              decoration:const InputDecoration(
                border: UnderlineInputBorder(),
                labelText: 'input tinggi balok / tinggi tabung',
              ),
